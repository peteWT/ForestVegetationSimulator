...
C                        ERROR NUMBER 50 PREVENT DEFECT CALLS WHEN FIAVBC ACTIVE
 6000 CONTINUE
...
C                        ERROR NUMBER 51 NOTIFY USER OF BOARD FOOT BFFDLN FUNCTION WHEN FIAVBC ACTIVE
 6100 CONTINUE
...
C                        ERROR NUMBER 52 NOTIFY USER OF FIAVBC DATABASE CALL WITHOUT FIAVBC CALL
 6200 CONTINUE
...
C                        ERROR NUMBER 53 NOTIFY USER OF INVALID ATTEMPT TO SET SCUFT MINHARVEST
 6300 CONTINUE
...
C                        ERROR NUMBER 54 NOTIFY USER OF INVALID SITE INDEX / SPECIES
 6400 CONTINUE
